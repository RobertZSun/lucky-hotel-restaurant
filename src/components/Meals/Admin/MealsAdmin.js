import styles from './MealsAdmin.module.css';
import {Fragment, useEffect, useState} from "react";
import Card from "../../UI/Card";
import MealsSectionAdmin from "./MealsSectionAdmin";
...
const MealsAdmin = () => {
    ...
    const mealsList = Object.keys(allMealsSections).map(sectionId =>
        <MealsSectionAdmin key={sectionId} id={sectionId} content={allMealsSections[sectionId]}/>);
